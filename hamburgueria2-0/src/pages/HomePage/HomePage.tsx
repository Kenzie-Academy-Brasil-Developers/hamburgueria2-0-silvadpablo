            ...
            <header>
                <div className="flex justify-between">
                    ...
                    <div className="flex header-menu">
                        <SearchInput/>
                        <span className="hidden"><p>0</p></span>
                        <img onClick={()=> setOpenDialog(true)} className="icon" src={cart} alt="shopping cart" />
                        <img onClick={HandleLogout} className="icon" src={logout} alt="Logout icon" />
                    </div>
                </div>
            </header>
            <main>
